          ...
          <div className="space-y-4 backdrop-blur-sm bg-navy-900/40 p-2 rounded-lg ">
            ...
            <ul className="space-y-3 text-cyan-300">
              <li className="flex items-start  transition-all duration-300 -ml-8 hover:translate-x-2 ">
                ...
                <a href="https://github.com/" target="_blank" rel="noopener noreferrer" className="no-underline text-cyan-300 hover:text-green-300"  >
                  Github
                </a>
              </li>
              <li className="flex items-start  transition-all duration-300 -ml-8 hover:translate-x-2">
                ...
                <a href="https://linkedin.com/in/" target="_blank" rel="noopener noreferrer" className="no-underline text-cyan-300 hover:text-green-300 ">
                  Linkedin
                </a>
              </li>
